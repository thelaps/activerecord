...
use component\CDb\schema\CDbExpression;
...
class CDbCommand extends CComponent
{
	...
	public function prepare()
	{
		if($this->_statement==null)
		{
			...
			catch(\Exception $e)
			{
				...
				throw new \Exception('CDbCommand failed to prepare the SQL statement: '.$e->getMessage());
			}
		}
	}
	...
	public function execute($params=array())
	{
		...
		catch(\Exception $e)
		{
			...
			throw new \Exception('CDbCommand failed to execute the SQL statement: '.$message);
		}
	}
